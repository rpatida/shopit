...
import { getProductDetail, newReview, clearErrors } from '../../actions/productActions';
                        ...
                        <div className="row f-flex justify-content-around">
                            ...
                            <div className="col-12 col-lg-5 mt-5">
                                ...
                                {user ? <button id="review_btn" type="button" className="btn btn-primary mt-4"
                                    data-toggle="modal" data-target="#ratingModal" onClick={submitYourRating}>
                                    Submit Your Review
                                </button> : <div className="alert alert-danger mt-5" type="alert">Login to post ypur reviews.</div>}
